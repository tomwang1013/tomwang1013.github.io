...
function merge(arr, p, q, r) {
  ...
  while (i <= q="" &&="" j="" <="r)" {="" if="" (arr[i]="" tmparr[k++]="arr[i++];" }="" else="" while="" (i="" (j="" k="0;" (k="" -="" p)="" arr[k="" +="" p]="tmpArr[k++];" test="" function="" assertarrequal(arr1,="" arr2)="" console.log('arr1:="" ',="" arr1,="" 'arr2:="" (arr1.length="" !="=" arr2.length)="" throw="" new="" error('arrs="" length="" not="" equal')="" arr1.foreach((element,="" i)=""> {
    if (element !== arr2[i]) {
